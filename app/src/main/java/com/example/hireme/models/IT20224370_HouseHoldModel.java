...
public class IT20224370_HouseHoldModel {
    ...
    public IT20224370_HouseHoldModel(String name, String type, String uName, String email, String location, String rate, String contact, String description, String image) {
        Name = name;
        Type = type;
        this.uName = uName;
        this.email = email;
