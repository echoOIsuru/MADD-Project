...
public class IT20224370_AdapterHousehold extends FirebaseRecyclerAdapter<IT20224370_HouseHoldModel, IT20224370_AdapterHousehold.myViewHolder> {
     ...
     * @param options
     */
    public IT20224370_AdapterHousehold(@NonNull FirebaseRecyclerOptions<IT20224370_HouseHoldModel> options) {
        super(options);
    }

    @Override
    protected void onBindViewHolder(@NonNull myViewHolder holder, int position, @NonNull IT20224370_HouseHoldModel model) {

        if (model.getType().equals("Household")) {                    //Industrial
